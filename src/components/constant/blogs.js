export const blogsData = [
  {
    cardImage: require("../../assets/images/blog-1.png"),
    topic: "Database",
  ...
  {
    cardImage: require("../../assets/images/blog-2.png"),
  ...
  {
    cardImage: require("../../assets/images/blog-3.png"),
    topic: "DatabaseAccessibility",
  ...
  {
    cardImage: require("../../assets/images/blog-4.png"),
    topic: "Database",
  ...
  {
    cardImage: require("../../assets/images/blog-5.png"),
    topic: "Web Performance",
    title: " Adaptive Loading - Improving Web Performance on low-end devices",
    text: " Adaptive Loading: Do not just respond based on screen size, adapt based on actual device hardware. Any user can have a slow experience. In a world with widely varying device capabilities, a one-size fits all experience may not always work. Sites that delight users on high-end device can be unusable on low-end ones, particularly on median mobile and desktop hardware and in emerging markets.",
    author: {
      name: "Julia Walker",
      Image: require("../../assets/images/author.png"),
      date: "Nov 10, 2021",
  ...
  {
    cardImage: require("../../assets/images/blog-6.png"),
    topic: "Accessibility",
    title:
  ...
  {
    cardImage: require("../../assets/images/blog-7.png"),
    topic: "Database",
  ...
  {
    cardImage: require("../../assets/images/blog-8.png"),
    topic: "Web Performance",
  ...
  {
    cardImage: require("../../assets/images/blog-9.png"),
    topic: "Accessibility",
  ...
  {
    cardImage: require("../../assets/images/blog-10.png"),
    topic: "Database",
